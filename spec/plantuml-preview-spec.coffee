PlantumlPreview = require '../lib/plantuml-preview'
...
describe "PlantumlPreview", ->
  ...
  describe "when the plantuml-preview:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        plantumlPreviewElement = workspaceElement.querySelector('.plantuml-preview')
